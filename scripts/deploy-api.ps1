...
gcloud run deploy $Service `
    ...
    --min-instances 0 `
    --max-instances 5 `
    --set-env-vars "NODE_ENV=production,USE_MOCKS=false,JWT_ACCESS_EXPIRES=15m,JWT_REFRESH_EXPIRES=90d,COOKIE_SAME_SITE=lax,CLOUDINARY_FOLDER=luxtime/watches" `
