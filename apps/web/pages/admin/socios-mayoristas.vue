...
async function createAccess() {
  ...
  creating.value = true;
  try {
    await api.post<WholesaleAccessDto>('/wholesale-access', { ...form });
...
useSeoMeta({ title: 'Socios mayoristas — Luxtime Admin' });
</script>
  ...
  <div class="admin-records-page">
    ...
    <section class="admin-record-export">
      ...
      <div class="grid gap-3 md:grid-cols-2">
        ...
        <UiLuxInput v-model="form.email" type="email" placeholder="Correo" />
        ...
        <div class="admin-record-details-inner" style="padding: 16px;">
          <div class="flex flex-wrap justify-between gap-3">
            <div>
              ...
              <p class="admin-record-muted">{{ item.email }}</p>
